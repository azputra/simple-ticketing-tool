...
const Detail : FC = () => {
  const { tickets, removeTicket, setupLoading, loading, setupAlert, alertMessage } = useContext(TicketContext) as TicketContextType;
  ...
  return (
    <>
      ...
      <div className="flex justify-center pt-24 animate__animated animate__pulse">
        {
          alertMessage === 'competed to progress' ?
      ...
      <EditTicket ticketDetail={ticketDetail} setAlertActive={setupAlert}/>
